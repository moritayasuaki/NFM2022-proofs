...
module Semantics {_≟V_ : Decidable (_≡_ {A = Var})} where
  ...
  module Untyped where
    ...
    ⦅ add ⦆ rs (sto , z2 ∷ z1 ∷ stk) _ = inj₁ (success (sto , z1  Int.+ z2 ∷ stk))
    ⦅ mul ⦆ rs (sto , z2 ∷ z1 ∷ stk) _ = inj₁ (success (sto , z1 Int.* z2 ∷ stk))
    ⦅ and ⦆ rs (sto , z2 ∷ z1 ∷ stk) _ = inj₁ (success (sto , Btoℤ ((ℤtoB z1) ∧ (ℤtoB z2)) ∷ stk))
  ...
  module NRSemantics where
    ...
    ⟦ and ⟧ n (sto , (z2 ∷ z1 ∷ stk)) = success (sto , Btoℤ ((ℤtoB z1) ∧ (ℤtoB z2)) ∷ stk)
    ⟦ mul ⟧ n (sto , (z2 ∷ z1 ∷ stk)) = success (sto , z1 Int.* z2 ∷ stk)
    ⟦ add ⟧ n (sto , (z2 ∷ z1 ∷ stk)) = success (sto , z1 Int.+ z2 ∷ stk)
